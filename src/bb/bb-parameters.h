...
struct bbparameters {
	const bool
		...
		fb,
		// Whether or not to try finding completions
		co;
	...
	bbparameters(bool _pb, bool _epb, bool _mb, bool _fb, bool _co, int _U0, float _Uf)
		: pb(_pb), epb(_epb), mb(_mb), fb(_fb), co(_co), U0(_U0), Uf(_Uf) { }
